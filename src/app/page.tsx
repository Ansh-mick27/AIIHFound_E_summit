  ...
  return (
    <div className="min-h-screen bg-slate-950 pb-20">
      ...
      <main className="bento-grid pt-24">
        ...
        <div className="bento-card col-span-4 md:col-span-2 row-span-2 justify-center items-center text-center py-12 px-8 bg-gradient-to-br from-indigo-900 to-slate-900 border-indigo-500/30">
        ...
        {/* 2. Countdown Timer */}
        <div className="bento-card col-span-4 md:col-span-2 justify-center items-center text-center bg-slate-900">
          <p className="text-slate-400 text-sm uppercase tracking-widest mb-4">Time Remaining</p>
          <CountdownTimer />
        </div>

        {/* 3. Stats Block 1 */}
        <div className="bento-card col-span-2 md:col-span-1 justify-center items-center text-center bg-slate-900 hover:border-orange-500/50">
          <p className="text-4xl font-black text-orange-500">₹1.2L</p>
          <p className="text-slate-400 text-sm mt-1">Prize Pool</p>
        </div>

        {/* 4. Stats Block 2 */}
        <div className="bento-card col-span-2 md:col-span-1 justify-center items-center text-center bg-slate-900 hover:border-cyan-500/50">
          <p className="text-4xl font-black text-cyan-500">25+</p>
          <p className="text-slate-400 text-sm mt-1">Cities</p>
        </div>

        {/* 5. SolveX Feature */}
        <Link href="/solvex" className="bento-card col-span-4 md:col-span-2 row-span-2 group relative overflow-hidden text-center items-center">
          ...
          <div className="relative z-10 p-4 flex flex-col items-center h-full w-full">
            ...
            <p className="text-slate-300 text-sm mb-6 max-w-sm">National Innovation & Business Model Competition</p>
        ...
        {/* 6. PitchBiz Feature */}
        <Link href="/pitchbiz" className="bento-card col-span-4 md:col-span-2 lg:col-span-2 group relative overflow-hidden text-center items-center">
          ...
          <div className="relative z-10 p-4 flex flex-col items-center h-full w-full">
            ...
            <p className="text-slate-300 text-sm max-w-sm">Investor & Startup Discovery Platform</p>
