    ...
    return (
        <footer className="bg-bg-secondary border-t border-white/10">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        >
                            <div className="space-y-3 font-mono-terminal text-sm">
                                ...
                                <div>
                                    <span className="text-white">Pradhyumn Mehta, +918770527096</span>
                                </div>
                                <div>
                                    <span className="text-white">Keshav Banger, +919399148486</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <div className="border-t border-white/10 py-6 px-6">
                <div className="max-w-7xl mx-auto px-6 relative z-50 flex justify-center items-center">
                    <button
